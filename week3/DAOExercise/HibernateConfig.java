...
public class HibernateConfig {
    ...
    static EntityManagerFactory buildEntityFactoryConfig() {
        try {
            ...
            props.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/jpql_queries?currentSchema=public");
